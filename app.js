...
async function a_draft_start() {
  try {
    ...
    const response = await fetch("https://19c5d00c-4bcb-4c9e-b73b-ea7dbae4e736-00-3cdgwp38kfppi.worf.replit.dev:3003/drafts_db?process_name=process-a");
    if (!response.ok) {
...
app.listen(PORT, () => {
  ...
  setInterval(() => {    a_draft_start();  console.log("///???a_draft_start")    }, 28000); 
